const Contact = () => {
  return (
    <section className="min-h-screen bg-white dark:bg-gray-900 lg:flex" >
      <div className="flex flex-col justify-center w-full p-8 lg:bg-gray-100 lg:dark:bg-gray-500 lg:px-12 xl:px-32 lg:w-1/2" style={{ backgroundImage: `url('/contactimage.jpg')`, backgroundSize: 'cover' }}>
      </div>
